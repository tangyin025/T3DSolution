...
namespace my
{
		...
		const t3d::Vec4<real> & color)
	{
		...
		rc->drawTriangleListSolidZBufferRW(color);
	}
	...
	void Object::drawSolidZBufferRWWithBackface(
		t3d::RenderContext * rc,
		const t3d::Vec4<real> & color)
	{
		rc->clearVertexList();
		...
		rc->drawTriangleListSolidZBufferRWWithBackface(color);
	}
	...
	//void SimpleAxisAlignedBoxObject::initAxisAlignedBoxList(void)
	//{
	//	assert(0 == getVertexListSize() % 3);

	//	m_axisAlignedBoxList.resize(getVertexListSize() / 3, AxisAlignedBox(my::Vec4<real>::ZERO, my::Vec4<real>::ZERO));

	//	for(size_t i = 0; i < m_axisAlignedBoxList.size(); i++)
	//	{
	//		m_axisAlignedBoxList[i] = buildAxisAlignedBoxFromTriangle(
	//			vertexAt(i * 3 + 0),
	//			vertexAt(i * 3 + 1),
	//			vertexAt(i * 3 + 2));
	//	}
	...
	//void SimpleAxisAlignedBoxObject::drawWireZBufferRWInsideBox(
	//	t3d::RenderContext * rc,
	...
	//	for(size_t i = 0; i < m_axisAlignedBoxList.size(); i++)
	//	{
	//		if(m_axisAlignedBoxList[i].intersection(box))
	//		{
	//			rc->pushVertexList(getVertexListBegin() + i * 3, getVertexListBegin() + i * 3 + 3);
	//		}
	//	}
	...
	//		if(m_axisAlignedBoxList[i].intersection(box))
	//		{
	//			rc->pushVertexList(getVertexListBegin() + i * 3, getVertexListBegin() + i * 3 + 3, mmat);
	//		}
	//	}
	...
	//void SimpleAxisAlignedBoxObject::drawWireZBufferRWWithoutThirdInsideBox(
	//	t3d::RenderContext * rc,
	//	const AxisAlignedBox & box,
	//	const t3d::Vec4<real> & color)
	//{
	...
	//void SimpleAxisAlignedBoxObject::drawWireZBufferRWWithBackfaceInsideBox(
	//	t3d::RenderContext * rc,
	//	const AxisAlignedBox & box,
	//	const t3d::Vec4<real> & color)
	//{
	...
	//void SimpleAxisAlignedBoxObject::drawWireZBufferRWWithBackfaceWithoutThirdInsideBox(
	//	t3d::RenderContext * rc,
	//	const AxisAlignedBox & box,
	//	const t3d::Vec4<real> & color)
	//{
	...
	//void SimpleAxisAlignedBoxObject::drawGouraudZBufferRWInsideBox(
	//	t3d::RenderContext * rc,
	//	const AxisAlignedBox & box)
	//{
	//	assert(getVertexListSize() == getNormalListSize());
	...
	//		{
	//			rc->pushVertexList(getVertexListBegin() + i * 3, getVertexListBegin() + i * 3 + 3);
	//			rc->pushNormalList(getNormalListBegin() + i * 3, getNormalListBegin() + i * 3 + 3);
	//		}
	//	}
	...
	//		{
	//			rc->pushVertexList(getVertexListBegin() + i * 3, getVertexListBegin() + i * 3 + 3, mmat);
	//			rc->pushNormalList(getNormalListBegin() + i * 3, getNormalListBegin() + i * 3 + 3, mrot);
	//		}
	//	}
	...
	////void SimpleAxisAlignedBoxObject::drawGouraudZBufferRWWithBackfaceInsideBox(
	////	t3d::RenderContext * rc,
	////	const AxisAlignedBox & box)
	////{
	////	assert(getVertexListSize() == getNormalListSize());
	...
	//void SimpleAxisAlignedBoxObject::drawTextureZBufferWInsideBox(
	//	t3d::RenderContext * rc,
	//	const AxisAlignedBox & box)
	//{
	//	//assert(getVertexListSize() == getNormalListSize());
	...
	//			rc->pushVertexList(getVertexListBegin() + i * 3, getVertexListBegin() + i * 3 + 3);
	//			//rc->pushNormalList(getNormalListBegin() + i * 3, getNormalListBegin() + i * 3 + 3);
	//			rc->pushUVList(getUVListBegin() + i * 3, getUVListBegin() + i * 3 + 3);
	//		}
	//	}
	...
	////void SimpleAxisAlignedBoxObject::drawTextureZBufferWWithBackfaceInsideBox(
	////	t3d::RenderContext * rc,
	////	const AxisAlignedBox & box)
	////{
	////	//assert(getVertexListSize() == getNormalListSize());
	...
	//void SimpleAxisAlignedBoxObject::drawTextureZBufferRWInsideBox(
	//	t3d::RenderContext * rc,
	//	const AxisAlignedBox & box)
	//{
	//	//assert(getVertexListSize() == getNormalListSize());
	...
	////void SimpleAxisAlignedBoxObject::drawTextureZBufferRWWithBackfaceInsideBox(
	////	t3d::RenderContext * rc,
	////	const AxisAlignedBox & box)
	////{
	////	//assert(getVertexListSize() == getNormalListSize());
	...
	//void SimpleAxisAlignedBoxObject::drawGouraudTextureZBufferRWInsideBox(
	//	t3d::RenderContext * rc,
	//	const AxisAlignedBox & box)
	//{
	//	assert(getVertexListSize() == getNormalListSize());
	...
	//void SimpleAxisAlignedBoxObject::drawGouraudTextureZBufferRWWithBackfaceInsideBox(
	//	t3d::RenderContext * rc,
	//	const AxisAlignedBox & box)
	//{
	//	assert(getVertexListSize() == getNormalListSize());
	...
	//void SimpleAxisAlignedBoxObject::drawGouraudTexturePerspectiveLPZBufferRWInsideBox(
	//	t3d::RenderContext * rc,
	//	const AxisAlignedBox & box)
	//{
	//	assert(getVertexListSize() == getNormalListSize());
		...
		const t3d::Vec4<real> & color)
	{
		...
		rc->drawTriangleIndexListSolidZBufferRW(color);
	}
	...
	void IndexObject::drawSolidZBufferRWWithBackface(
		t3d::RenderContext * rc,
		const t3d::Vec4<real> & color)
	{
		rc->clearVertexList();
		...
		rc->drawTriangleIndexListSolidZBufferRWWithBackface(color);
	}
