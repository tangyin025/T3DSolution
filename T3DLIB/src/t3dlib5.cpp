...
typedef struct SCANCONTEXT_TYP
{
	...
	FIXP16		lu, ru, lu_inc, ru_inc;
	FIXP16		lv, rv, lv_inc, rv_inc;
...
static void Draw_Scan_Texture_SrcKey_ZBufferRW16(SCANCONTEXT & sc, const int y_beg, const int y_end, const RENDERCONTEXTV1 * prc)
{
#define __draw_UV
#define __draw_SRC_KEY
#define __draw_ZB
#define __draw_16
#include "t3dlib5.Draw_Clipped_Scan_Gouraud_Texture_ZBufferRW.hpp"
}

static void Draw_Scan_Texture_SrcKey_ZBufferRW32(SCANCONTEXT & sc, const int y_beg, const int y_end, const RENDERCONTEXTV1 * prc)
{
#define __draw_UV
#define __draw_SRC_KEY
#define __draw_ZB
...
static void Draw_Scan_Gouraud_Texture_SrcKey_ZBufferRW16(SCANCONTEXT & sc, const int y_beg, const int y_end, const RENDERCONTEXTV1 * prc)
{
#define __draw_UV
#define __draw_GR
#define __draw_SRC_KEY
...
static void Draw_Scan_Gouraud_Texture_SrcKey_ZBufferRW32(SCANCONTEXT & sc, const int y_beg, const int y_end, const RENDERCONTEXTV1 * prc)
{
#define __draw_UV
#define __draw_GR
#define __draw_SRC_KEY
...
static void Draw_Clipped_Scan_Texture_SrcKey_ZBufferRW16(SCANCONTEXT & sc, const int y_beg, const int y_end, const RENDERCONTEXTV1 * prc)
{
#define __draw_UV
#define __draw_SRC_KEY
#define __draw_ZB
...
static void Draw_Clipped_Scan_Texture_SrcKey_ZBufferRW32(SCANCONTEXT & sc, const int y_beg, const int y_end, const RENDERCONTEXTV1 * prc)
{
#define __draw_UV
#define __draw_SRC_KEY
#define __draw_ZB
...
static void Draw_Clipped_Scan_Gouraud_Texture_SrcKey_ZBufferRW16(SCANCONTEXT & sc, const int y_beg, const int y_end, const RENDERCONTEXTV1 * prc)
{
#define __draw_UV
#define __draw_GR
#define __draw_SRC_KEY
...
static void Draw_Clipped_Scan_Gouraud_Texture_SrcKey_ZBufferRW32(SCANCONTEXT & sc, const int y_beg, const int y_end, const RENDERCONTEXTV1 * prc)
{
#define __draw_UV
#define __draw_GR
#define __draw_SRC_KEY
...
T3DLIB_API void (* Draw_Triangle_Texture_SrcKey_ZBufferRW)(const RENDERCONTEXTV1 * prc, const VERTEXV1T * pv0, const VERTEXV1T * pv1, const VERTEXV1T * pv2) = NULL;
...
T3DLIB_API void (* Draw_Triangle_Gouraud_Texture_SrcKey_ZBufferRW)(const RENDERCONTEXTV1 * prc, const VERTEXV1T * pv0, const VERTEXV1T * pv1, const VERTEXV1T * pv2) = NULL;
...
T3DLIB_API void (* Draw_Clipped_Triangle_Texture_SrcKey_ZBufferRW)(const RENDERCONTEXTV1 * prc, const VERTEXV1T * pv0, const VERTEXV1T * pv1, const VERTEXV1T * pv2) = NULL;
...
T3DLIB_API void (* Draw_Clipped_Triangle_Gouraud_Texture_SrcKey_ZBufferRW)(const RENDERCONTEXTV1 * prc, const VERTEXV1T * pv0, const VERTEXV1T * pv1, const VERTEXV1T * pv2) = NULL;
...
T3DLIB_API bool Init_T3dlib5(int bpp)
{
	...
	case 16:
		...
		Draw_Triangle_Texture_SrcKey_ZBufferRW			= Draw_Triangle_Texture_SrcKey_ZBufferRW16;
		...
		Draw_Triangle_Gouraud_Texture_SrcKey_ZBufferRW	= Draw_Triangle_Gouraud_Texture_SrcKey_ZBufferRW16;
		...
		Draw_Clipped_Triangle_Texture_SrcKey_ZBufferRW	= Draw_Clipped_Triangle_Texture_SrcKey_ZBufferRW16;
		...
		Draw_Clipped_Triangle_Gouraud_Texture_SrcKey_ZBufferRW	= Draw_Clipped_Triangle_Gouraud_Texture_SrcKey_ZBufferRW16;
	...
	case 32:
		...
		Draw_Triangle_Texture_SrcKey_ZBufferRW			= Draw_Triangle_Texture_SrcKey_ZBufferRW32;
		Draw_Triangle_Texture_PerspectiveLP_ZBufferRW	= Draw_Triangle_Texture_PerspectiveLP_ZBufferRW32;
		...
		Draw_Triangle_Gouraud_Texture_SrcKey_ZBufferRW	= Draw_Triangle_Gouraud_Texture_SrcKey_ZBufferRW32;
		Draw_Triangle_Gouraud_Texture_PerspectiveLP_ZBufferRW	= Draw_Triangle_Gouraud_Texture_PerspectiveLP_ZBufferRW32;
		...
		Draw_Clipped_Triangle_Texture_SrcKey_ZBufferRW	= Draw_Clipped_Triangle_Texture_SrcKey_ZBufferRW32;
		...
		Draw_Clipped_Triangle_Gouraud_Texture_SrcKey_ZBufferRW	= Draw_Clipped_Triangle_Gouraud_Texture_SrcKey_ZBufferRW32;
...
T3DLIB_API void Draw_Triangle_Texture_SrcKey_ZBufferRW16(const RENDERCONTEXTV1 * prc, const VERTEXV1T * pv0, const VERTEXV1T * pv1, const VERTEXV1T * pv2)
{
#define __draw_func Draw_Scan_Texture_SrcKey_ZBufferRW16
#define __draw_UV
#define __draw_ZB
#define __draw_16
#include "t3dlib5.Draw_Clipped_Triangle_Gouraud_Texture_ZBufferRW.hpp"
...
T3DLIB_API void Draw_Triangle_Texture_SrcKey_ZBufferRW32(const RENDERCONTEXTV1 * prc, const VERTEXV1T * pv0, const VERTEXV1T * pv1, const VERTEXV1T * pv2)
{
#define __draw_func Draw_Scan_Texture_SrcKey_ZBufferRW32
#define __draw_UV
#define __draw_ZB
#define __draw_32
#include "t3dlib5.Draw_Clipped_Triangle_Gouraud_Texture_ZBufferRW.hpp"
...
T3DLIB_API void Draw_Triangle_Gouraud_Texture_SrcKey_ZBufferRW16(const RENDERCONTEXTV1 * prc, const VERTEXV1T * pv0, const VERTEXV1T * pv1, const VERTEXV1T * pv2)
{
#define __draw_func Draw_Scan_Gouraud_Texture_SrcKey_ZBufferRW16
#define __draw_UV
#define __draw_GR
#define __draw_ZB
#define __draw_16
...
T3DLIB_API void Draw_Triangle_Gouraud_Texture_SrcKey_ZBufferRW32(const RENDERCONTEXTV1 * prc, const VERTEXV1T * pv0, const VERTEXV1T * pv1, const VERTEXV1T * pv2)
{
#define __draw_func Draw_Scan_Gouraud_Texture_SrcKey_ZBufferRW32
#define __draw_UV
#define __draw_GR
#define __draw_ZB
#define __draw_32
...
T3DLIB_API void Draw_Clipped_Triangle_Texture_SrcKey_ZBufferRW16(const RENDERCONTEXTV1 * prc, const VERTEXV1T * pv0, const VERTEXV1T * pv1, const VERTEXV1T * pv2)
{
#define __draw_func Draw_Scan_Texture_SrcKey_ZBufferRW16
#define __draw_func_clipped Draw_Clipped_Scan_Texture_SrcKey_ZBufferRW16
#define __draw_UV
#define __draw_ZB
#define __draw_CLIP
#define __draw_16
...
T3DLIB_API void Draw_Clipped_Triangle_Texture_SrcKey_ZBufferRW32(const RENDERCONTEXTV1 * prc, const VERTEXV1T * pv0, const VERTEXV1T * pv1, const VERTEXV1T * pv2)
{
#define __draw_func Draw_Scan_Texture_SrcKey_ZBufferRW32
#define __draw_func_clipped Draw_Clipped_Scan_Texture_SrcKey_ZBufferRW32
#define __draw_UV
#define __draw_ZB
#define __draw_CLIP
#define __draw_32
...
T3DLIB_API void Draw_Clipped_Triangle_Gouraud_Texture_SrcKey_ZBufferRW16(const RENDERCONTEXTV1 * prc, const VERTEXV1T * pv0, const VERTEXV1T * pv1, const VERTEXV1T * pv2)
{
#define __draw_func Draw_Scan_Gouraud_Texture_SrcKey_ZBufferRW16
#define __draw_func_clipped Draw_Clipped_Scan_Gouraud_Texture_SrcKey_ZBufferRW16
#define __draw_UV
#define __draw_GR
#define __draw_ZB
#define __draw_CLIP
...
T3DLIB_API void Draw_Clipped_Triangle_Gouraud_Texture_SrcKey_ZBufferRW32(const RENDERCONTEXTV1 * prc, const VERTEXV1T * pv0, const VERTEXV1T * pv1, const VERTEXV1T * pv2)
{
#define __draw_func Draw_Scan_Gouraud_Texture_SrcKey_ZBufferRW32
#define __draw_func_clipped Draw_Clipped_Scan_Gouraud_Texture_SrcKey_ZBufferRW32
#define __draw_UV
#define __draw_GR
#define __draw_ZB
#define __draw_CLIP
