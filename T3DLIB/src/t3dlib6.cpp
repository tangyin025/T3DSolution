...
T3DLIB_API void Draw_Object4D_Texture_ZBufferRW16(OBJECT4DV1 * pobj, CAM4DV1 * pcam, MATERIALV1 * pmaterial)
{
	...
	for(i = 0; i < (int)pobj->tri_list.length; i++)
	{
		...
		case TRI_STATE_ACTIVE:
			...
			Draw_Triangle_Texture_ZBufferRW16(&rc,
		...
		case TRI_STATE_CLIPPED:
			...
			Draw_Clipped_Triangle_Texture_ZBufferRW16(&rc,
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v0_i],
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v1_i],
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v2_i]);
			break;
...
T3DLIB_API void Draw_Object4D_Texture_ZBufferRW32(OBJECT4DV1 * pobj, CAM4DV1 * pcam, MATERIALV1 * pmaterial)
{
	...
	for(i = 0; i < (int)pobj->tri_list.length; i++)
	{
		...
		case TRI_STATE_ACTIVE:
			...
			Draw_Triangle_Texture_ZBufferRW32(&rc,
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v0_i],
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v1_i],
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v2_i]);
			break;
		...
		case TRI_STATE_CLIPPED:
			...
			Draw_Clipped_Triangle_Texture_ZBufferRW32(&rc,
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v0_i],
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v1_i],
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v2_i]);
			break;
...
T3DLIB_API void Draw_Object4D_Texture_PerspectiveLP_ZBufferRW16(OBJECT4DV1 * pobj, CAM4DV1 * pcam, MATERIALV1 * pmaterial)
{
	...
	for(i = 0; i < (int)pobj->tri_list.length; i++)
	{
		...
		case TRI_STATE_ACTIVE:
			...
			Draw_Triangle_Texture_PerspectiveLP_ZBufferRW16(&rc,
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v0_i],
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v1_i],
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v2_i]);
			break;
		...
		case TRI_STATE_CLIPPED:
			...
			Draw_Clipped_Triangle_Texture_PerspectiveLP_ZBufferRW16(&rc,
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v0_i],
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v1_i],
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v2_i]);
			break;
...
T3DLIB_API void Draw_Object4D_Texture_PerspectiveLP_ZBufferRW32(OBJECT4DV1 * pobj, CAM4DV1 * pcam, MATERIALV1 * pmaterial)
{
	assert(pcam->psurf != NULL);
	assert(pcam->pzbuf != NULL);
	assert(pcam->psurf->color_shift == _32BIT_BYTES_SHIFT);
	...
	for(i = 0; i < (int)pobj->tri_list.length; i++)
	{
		...
		case TRI_STATE_CLIPPED:
			...
			Draw_Clipped_Triangle_Texture_PerspectiveLP_ZBufferRW32(&rc,
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v0_i],
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v1_i],
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v2_i]);
			break;
...
T3DLIB_API void Draw_Object4D_Gouraud_Texture_PerspectiveLP_ZBufferRW16(OBJECT4DV1 * pobj, CAM4DV1 * pcam, MATERIALV1 * pmaterial)
{
	...
	for(i = 0; i < (int)pobj->tri_list.length; i++)
	{
		...
		case TRI_STATE_ACTIVE:
			...
			Draw_Triangle_Gouraud_Texture_PerspectiveLP_ZBufferRW16(&rc,
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v0_i],
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v1_i],
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v2_i]);
			break;
		...
		case TRI_STATE_CLIPPED:
			...
			Draw_Clipped_Triangle_Gouraud_Texture_PerspectiveLP_ZBufferRW16(&rc,
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v0_i],
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v1_i],
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v2_i]);
			break;
...
T3DLIB_API void Draw_Object4D_Gouraud_Texture_PerspectiveLP_ZBufferRW32(OBJECT4DV1 * pobj, CAM4DV1 * pcam, MATERIALV1 * pmaterial)
{
	...
	for(i = 0; i < (int)pobj->tri_list.length; i++)
	{
		...
		case TRI_STATE_ACTIVE:
			...
			Draw_Triangle_Gouraud_Texture_PerspectiveLP_ZBufferRW32(&rc,
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v0_i],
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v1_i],
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v2_i]);
			break;
		...
		case TRI_STATE_CLIPPED:
			...
			Draw_Clipped_Triangle_Gouraud_Texture_PerspectiveLP_ZBufferRW32(&rc,
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v0_i],
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v1_i],
							&pobj->ver_list_t.elems[pobj->tri_list.elems[i].v2_i]);
			break;
