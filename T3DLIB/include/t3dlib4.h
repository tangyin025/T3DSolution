...
#define COLOR_ADD_16R(r0, r1)		(COLOR_TABLE_ADD[(r0)][(r1)])
#define COLOR_ADD_16G(g0, g1)		(COLOR_TABLE_ADD16G[(g0)][(g1)])
#define COLOR_ADD_16B(b0, b1)		(COLOR_TABLE_ADD[(b0)][(b1)])

#define COLOR_ADD_32R(r0, r1)		(COLOR_TABLE_ADD[(r0)][(r1)])
#define COLOR_ADD_32G(g0, g1)		(COLOR_TABLE_ADD[(g0)][(g1)])
#define COLOR_ADD_32B(b0, b1)		(COLOR_TABLE_ADD[(b0)][(b1)])

#define COLOR_MUL_16R(r0, r1)		(COLOR_TABLE_MUL[(r0)][(r1)])
#define COLOR_MUL_16G(g0, g1)		(COLOR_TABLE_MUL16G[(g0)][(g1)])
#define COLOR_MUL_16B(b0, b1)		(COLOR_TABLE_MUL[(b0)][(b1)])

#define COLOR_MUL_32R(r0, r1)		(COLOR_TABLE_MUL[(r0)][(r1)])
#define COLOR_MUL_32G(g0, g1)		(COLOR_TABLE_MUL[(g0)][(g1)])
#define COLOR_MUL_32B(b0, b1)		(COLOR_TABLE_MUL[(b0)][(b1)])
...
extern T3DLIB_API unsigned char COLOR_TABLE_ADD[MAX_COLOR_INTENSITY32][MAX_COLOR_INTENSITY32];
